...
Dune 3 in August 2021. As with previous major releases, we will put a lot of
effort in backward compatibility, which means the majority of Dune users should
